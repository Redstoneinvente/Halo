...
final class HaloWhatsNewCoordinator {
    ...
    func presentIfNeeded() {
        ...
        // First-run setup is already its own introduction. Mark brand-new installs as seen,
        // but show What's New when an existing Halo install advances to a new version.
        if previous == nil {
